package com.newrelic.otelplayground.simulator;
...
import com.newrelic.otelplayground.simulator.handlers.RestTemplateResponseErrorHandler;
...
public class SimulatorApplication {
	...
	public static void main(String[] args) {
		...
		OpenTelemetrySdk openTelemetrySdk = AutoConfiguredOpenTelemetrySdk.builder()
				...
				.build()
				.getOpenTelemetrySdk();
		SimulatorApplication.openTelemetry = openTelemetrySdk;
